 ...
 * did not read first. See ARCHITECTURE.md and docs/funding-data-loss-2026-07-29.md.
 */
...
async function run() {
  ...
  // is exactly what the write invariant in ARCHITECTURE.md forbids. Per-row updates
