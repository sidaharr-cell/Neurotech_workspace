...
`refresh-home-images` skill in `.claude/skills/`, and is written back as data.
...
- **`CLAUDE.md`** at the repository root is the real architectural record. It is
...
Read `CLAUDE.md` before changing anything in `scripts/` or in the image
